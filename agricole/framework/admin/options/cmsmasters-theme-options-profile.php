...
if (!function_exists('agricole_get_custom_profile_meta_fields')) {
function agricole_get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_title = (isset($cmsmasters_option['agricole' . '_profile_post_title']) && $cmsmasters_option['agricole' . '_profile_post_title'] !== '') ? (($cmsmasters_option['agricole' . '_profile_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option['agricole' . '_profile_post_details_title']) && $cmsmasters_option['agricole' . '_profile_post_details_title'] !== '') ? $cmsmasters_option['agricole' . '_profile_post_details_title'] : '';
	
	$cmsmasters_global_profile_post_share_box = (isset($cmsmasters_option['agricole' . '_profile_post_share_box']) && $cmsmasters_option['agricole' . '_profile_post_share_box'] !== '') ? (($cmsmasters_option['agricole' . '_profile_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	...
	$tabs_array['cmsmasters_profile'] = array( 
		'label' => esc_html__('Profile', 'agricole'), 
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'agricole'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'agricole'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'agricole'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'agricole'), 
			'desc'	=> '', 
