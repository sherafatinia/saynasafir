...
if (!function_exists('agricole_get_custom_project_meta_fields')) {
function agricole_get_custom_project_meta_fields() {
	...
	$cmsmasters_global_portfolio_project_title = (isset($cmsmasters_option['agricole' . '_portfolio_project_title']) && $cmsmasters_option['agricole' . '_portfolio_project_title'] !== '') ? (($cmsmasters_option['agricole' . '_portfolio_project_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_project_details_title = (isset($cmsmasters_option['agricole' . '_portfolio_project_details_title']) && $cmsmasters_option['agricole' . '_portfolio_project_details_title'] !== '') ? $cmsmasters_option['agricole' . '_portfolio_project_details_title'] : '';
	
	$cmsmasters_global_portfolio_project_share_box = (isset($cmsmasters_option['agricole' . '_portfolio_project_share_box']) && $cmsmasters_option['agricole' . '_portfolio_project_share_box'] !== '') ? (($cmsmasters_option['agricole' . '_portfolio_project_share_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_project_author_box = (isset($cmsmasters_option['agricole' . '_portfolio_project_author_box']) && $cmsmasters_option['agricole' . '_portfolio_project_author_box'] !== '') ? (($cmsmasters_option['agricole' . '_portfolio_project_author_box'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_portfolio_more_projects_box = (isset($cmsmasters_option['agricole' . '_portfolio_more_projects_box'])) ? $cmsmasters_option['agricole' . '_portfolio_more_projects_box'] : 'related';
	
	$cmsmasters_proportion = agricole_project_puzzle_proportion();
	...
	$tabs_array['cmsmasters_project'] = array( 
		'label' => esc_html__('Project', 'agricole'), 
	...
	$custom_project_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Project Images', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Project', 'agricole'), 
			'desc'	=> esc_html__('Don\'t Show', 'agricole'), 
		...
		array( 
			'label'	=> esc_html__('Number of Columns', 'agricole'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'three' => array( 
					'label' => esc_html__('Three', 'agricole'), 
					'value'	=> 'three' 
				), 
				'two' => array( 
					'label' => esc_html__('Two', 'agricole'), 
					'value'	=> 'two' 
				), 
				'one' => array( 
					'label' => esc_html__('One', 'agricole'), 
					'value'	=> 'one' 
				) 
			) 
		),
		...
		array( 
			'label'	=> esc_html__('Video Type', 'agricole'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'embedded' => array( 
					'label' => esc_html__('Embedded (YouTube, Vimeo)', 'agricole'), 
					'value'	=> 'embedded' 
				), 
				'selfhosted' => array( 
					'label' => esc_html__('Self-Hosted', 'agricole'), 
					'value'	=> 'selfhosted' 
				) 
			) 
		), 
		array( 
			'label'	=> esc_html__('Embedded Video Link', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Self-Hosted Video Links', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Title', 'agricole'), 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image Size', 'agricole'), 
			'desc'	=> esc_html__('Recommended Project Puzzle Image dimensions, or other size, with the same ratio', 'agricole') . ' - ', 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image', 'agricole'), 
			'desc'	=> esc_html__('Choose image for Masonry Puzzle portfolio projects', 'agricole'), 
		...
		array( 
			'label'	=> esc_html__('Project Details Title', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Info', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__("Project Link Text", 'agricole'), 
			'desc'	=> '', 
			'id'	=> $cmsmasters_option_name . 'link_text', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('View Project', 'agricole') 
		), 
		array( 
			'label'	=> esc_html__("Project Link URL", 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> '', 
			'desc'	=> esc_html__('Redirect to project link URL instead of opening project page', 'agricole'), 
		...
		array( 
			'label'	=> esc_html__("Project Link Target", 'agricole'), 
			'desc'	=> esc_html__('Open link in a new tab', 'agricole'), 
		...
		array( 
			'label'	=> esc_html__('Project Features 1 Title', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 1', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2 Title', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3 Title', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3', 'agricole'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Sharing Box', 'agricole'), 
			'desc'	=> esc_html__('Show', 'agricole'), 
		...
		array( 
			'label'	=> esc_html__('About Author Box', 'agricole'), 
			'desc'	=> esc_html__('Show', 'agricole'), 
		...
		array( 
			'label'	=> esc_html__('More Posts Box', 'agricole'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'related' => array( 
					'label' => esc_html__('Show Related Tab', 'agricole'), 
					'value'	=> 'related' 
				), 
				'popular' => array( 
					'label' => esc_html__('Show Popular Tab', 'agricole'), 
					'value'	=> 'popular' 
				), 
				'recent' => array( 
					'label' => esc_html__('Show Recent Tab', 'agricole'), 
					'value'	=> 'recent' 
				), 
				'hide' => array( 
					'label' => esc_html__('Hide More Posts Box', 'agricole'), 
					'value'	=> 'hide' 
				) 
			) 
		), 
