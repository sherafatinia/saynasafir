...
<article id="post-<?php the_ID(); ?>" <?php post_class('cmsmasters_profile_vertical'); ?>>
	...
	if (has_post_thumbnail()) {
		agricole_thumb(get_the_ID(), 'cmsmasters-square-thumb', true, false, false, false, false);
	} else {
	...
	echo '<div class="profile_inner">';
		...
		agricole_profile_heading(get_the_ID(), 'h3', $cmsmasters_profile_subtitle, 'h5');
		
		agricole_profile_exc_cont();
		
		agricole_profile_social_icons($cmsmasters_profile_social, $profile_id);
